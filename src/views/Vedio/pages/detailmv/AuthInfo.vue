    ...
    <div class="info-avatar">
      <span>
        <a-avatar
          ...
          :src="data.artistName"
        />
        <span class="info-auth">&nbsp;{{data.artistName}}</span>
      </span>
      <span>
